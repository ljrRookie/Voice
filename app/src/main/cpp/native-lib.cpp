...
#define LOGI(FORMAT,...) __android_log_print(ANDROID_LOG_INFO,"ljr",FORMAT,##__VA_ARGS__);
#define LOGE(FORMAT,...) __android_log_print(ANDROID_LOG_ERROR,"ljr",FORMAT,##__VA_ARGS__);
...
Java_com_ljr_voice_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_ljr_voice_Player_sound(JNIEnv *env, jobject instance, jstring input_, jstring output_) {
